...
public class JwtUtil {
    ...
    private static final String SECRET_KEY = System.getProperty("secret.key"); //get from VM option
    private static final String ISSUER = "com.ascending";
    private static final long EXPIRATION_TIME = 86400 * 1000; //unit milli second
